...
export const getInstitutions: RequestHandler = async (
  req: Request,
  res: Response
) => {
  try {
...
export const deleteInstitution: RequestHandler = async (
  ...
  try {
    ...
    const deleteAdmins = await userService.deleteInstitutionAdmins(
      req.body.institutionId
    );
    if (!deleteAdmins) throw new Error("could not delete admins");
